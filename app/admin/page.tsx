...
import { logoutAdmin, updatePage, updateSite } from "@/app/actions";
...
export default function AdminDashboard() {
  ...
  return (
    <main style={{ padding: "32px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <form action={updatePage} style={{ background: "#fff", padding: "24px", borderRadius: "12px", border: "1px solid #ddd" }}>
